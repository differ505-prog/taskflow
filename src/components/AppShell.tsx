    ...
    <div className="flex flex-col h-full">
      ...
      <header className="flex-shrink-0 glass sticky top-0 z-30">
        ...
        <main className="flex-1 flex flex-col overflow-hidden md:flex-row">
          ...
          <div className={`flex-1 overflow-y-auto overscroll-contain px-6 py-5 pb-[calc(96px+env(safe-area-inset-bottom,0px)+24px)] md:pb-5 ${selectedTaskId ? "hidden md:flex md:flex-col" : "flex flex-col"}`}>
            {/* Viewer 唯讀提示 */}
            {isReadOnlyShared && (
              <div
